                ...
                <div class="border-t border-amber-100 pt-5">
                    ...
                    <div>
                        ...
                        <textarea name="story" id="story" rows="3" 
                                  ...
                                  class="w-full px-4 py-3 rounded-xl border {{ $errors->has('story') ? 'border-rose-300' : 'border-amber-100' }} bg-amber-50/40 text-sm text-amber-950 outline-none resize-none">{{ old('story', $product->story) }}</textarea>
