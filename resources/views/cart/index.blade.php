...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="/products" class="text-sm font-medium text-amber-800 hover:text-amber-600 transition-colors flex items-center">
    ...
    <div class="bg-white rounded-3xl p-12 text-center border border-amber-100 shadow-sm max-w-md mx-auto my-12">
        ...
        <a href="/products" class="inline-flex items-center px-6 py-3 bg-amber-800 hover:bg-amber-900 text-white text-sm font-bold rounded-xl transition-all shadow-md hover:-translate-y-0.5">
            Mulai Belanja
        </a>
    </div>
    @else
        ...
        <div class="w-full lg:w-2/3 space-y-4">
            ...
            <div class="bg-white p-4 rounded-2xl border border-amber-100 shadow-sm flex flex-col sm:flex-row items-center gap-4 transition-all hover:shadow-md">
                ...
                <div class="flex-grow text-center sm:text-left w-full sm:w-auto">
                    ...
                    <h3 class="text-lg font-bold text-amber-950 line-clamp-1">{{ $item->product->name }}</h3>
                    <p class="text-amber-700 font-bold mt-1">Rp {{ number_format($item->product->price, 0, ',', '.') }}</p>
                </div>
