...
<section class="relative bg-[#1a1512] py-24 sm:py-32 overflow-hidden">
    ...
    <div class="relative max-w-4xl mx-auto px-5 text-center text-white">
        ...
        <h1 class="text-4xl sm:text-6xl font-black leading-tight mb-6">Tentang TepiKopi.</h1>
...
<section class="py-16 sm:py-24 bg-white">
    <div class="max-w-6xl mx-auto px-5 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
            <h2 class="text-3xl sm:text-4xl font-black text-amber-950 mb-6">Perjalanan Kami</h2>
            <p class="text-amber-900/80 leading-relaxed mb-4">
...
<section class="py-16 sm:py-24 bg-amber-50">
    <div class="max-w-6xl mx-auto px-5">
        <h2 class="text-center text-3xl sm:text-4xl font-black text-amber-950 mb-12">Yang Kami Pegang Teguh</h2>
        <div class="grid sm:grid-cols-3 gap-8">
            @foreach([
                ...
                <div class="bg-white p-8 rounded-2xl border border-amber-100 text-center">
                    <div class="w-14 h-14 mx-auto mb-5 rounded-xl bg-amber-800 text-white flex items-center justify-center text-xl">
                        <i class="fa-solid {{ $nilai['icon'] }}"></i>
                    </div>
                    <h3 class="font-bold text-amber-950 text-lg mb-2">{{ $nilai['title'] }}</h3>
                    <p class="text-amber-900/70 text-sm leading-relaxed">{{ $nilai['desc'] }}</p>
                </div>
            @endforeach
        </div>
    </div>
...
<section class="py-16 sm:py-20 bg-amber-950">
    <div class="max-w-4xl mx-auto px-5 text-center">
        <h2 class="text-2xl sm:text-3xl font-black text-white mb-4">Siap mencicipi kopi pilihan kami?</h2>
        <p class="text-amber-200/70 mb-8">Jelajahi katalog dan temukan kopi favoritmu hari ini.</p>
        <a href="/katalog" class="inline-block px-8 py-4 bg-amber-700 hover:bg-amber-600 rounded-lg text-white font-bold uppercase tracking-widest transition">
            Lihat Katalog
        </a>
    </div>
</section>
